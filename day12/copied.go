...
// // // 		z: 0,
// // // 	}
// // // 	vel = vel.Plus(right.Minus(left).Sign())
// // // 	fmt.Println(vel)
// // // 	// a.vel.Plus(b.pos.Minus(a.pos).Sign())
...
// // 		fmt.Printf("x was %d, y was %d, and z was %d, lcm of them was %d\n", xSteps, ySteps, zSteps, result)
// // 		fmt.Println(result)
// // 	}
// // }
